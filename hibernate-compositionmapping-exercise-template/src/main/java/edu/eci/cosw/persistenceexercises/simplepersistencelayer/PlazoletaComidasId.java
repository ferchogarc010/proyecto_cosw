...
/**
 * PlazoletaComidasId generated by hbm2java
 */
@Embeddable
public class PlazoletaComidasId  implements java.io.Serializable {


     private String idPlazoletaComidas;
     private String ciudad;

    public PlazoletaComidasId() {
    }

    public PlazoletaComidasId(String idPlazoletaComidas, String ciudad) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PlazoletaComidasId) ) return false;
		 PlazoletaComidasId castOther = ( PlazoletaComidasId ) other; 
